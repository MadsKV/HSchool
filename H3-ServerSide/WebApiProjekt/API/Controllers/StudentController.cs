...
namespace API.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        // GET: CityController
        [HttpGet]
        public async Task<IActionResult> GetStudents(bool includeRelations = true)
        {
            ...
            var StudentList = await _repositoryWrapper.StudentRepositoryWrapper.FindAll();

            List<StudentDto> studentDtos;

            studentDtos = StudentList.Adapt<StudentDto[]>().ToList();
