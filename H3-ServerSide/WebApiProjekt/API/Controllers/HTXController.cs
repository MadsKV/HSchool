...
namespace API.Controllers
{
    ...
    [ApiController]
    public class HTXController : ControllerBase
    {
        private IRepositoryWrapper _repositoryWrapper;

        public HTXController(IRepositoryWrapper repositoryWrapper)
        {
        ...
        // GET: CityController
        [HttpGet]
        public async Task<IActionResult> GetHTXStudent(bool includeRelations = true)
        {
            ...
            var HTXList = await _repositoryWrapper.HTXStudentRepositoryWrapper.FindAll();

            List<HTXStudentDto> hTXStudentDtos;

            hTXStudentDtos = HTXList.Adapt<HTXStudentDto[]>().ToList();
