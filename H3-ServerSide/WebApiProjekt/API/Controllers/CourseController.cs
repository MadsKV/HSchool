...
namespace API.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        public CourseController(IRepositoryWrapper repositoryWrapper)
        {
        ...
        // GET: CityController
        [HttpGet]
        public async Task<IActionResult> GetCourses(bool includeRelations = true)
        {
            ...
            var CourseList = await _repositoryWrapper.CourseRepositoryWrapper.FindAll();

            List<CourseDto> courseDtos;

            courseDtos = CourseList.Adapt<CourseDto[]>().ToList();
