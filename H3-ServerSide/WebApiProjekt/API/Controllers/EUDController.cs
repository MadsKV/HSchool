...
namespace API.Controllers
{
    ...
    [ApiController]
    public class EUDController : ControllerBase
    {
        private IRepositoryWrapper _repositoryWrapper;

        public EUDController(IRepositoryWrapper repositoryWrapper)
        {
        ...
        // GET: CityController
        [HttpGet]
        public async Task<IActionResult> GetEUDStudent(bool includeRelations = true)
        {
            ...
            var EUDList = await _repositoryWrapper.EUDStudentRepositoryWrapper.FindAll();

            List<EUDStudentDto> eUDStudentDtos;

            eUDStudentDtos = EUDList.Adapt<EUDStudentDto[]>().ToList();
